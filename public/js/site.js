...
jQuery(document).ready(function($) {
	$('body').on('click', '.user-login', function(event) {
		...
		$('body').find('.login-form-div').show();
		$('body').find('.user-signup').removeClass('current');
		
	});
	$('body').on('click', '.user-signup', function(event) {
		$('body').find('.register-form-div').show();
		$('body').find('.login-form-div').hide();
		$('body').find('.user-login').removeClass('current');
	...
	$('body').on('click', '.log-btn', function(event) {
		event.preventDefault();
		$('body').find('.register-form-div').hide();
		$('body').find('.login-form-div').show();
		$('body').find('.user-signup').removeClass('current');
